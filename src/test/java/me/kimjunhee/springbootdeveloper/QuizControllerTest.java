...
public class QuizControllerTest {
    ...
    @Autowired
    private ObjectMapper objectMapper; // json간의 변환을 처리
    ...
    @DisplayName("quiz(): POST /quiz?code=1 이면 응답 코드는 403, 응답 본문은" +
    ...
    @DisplayName("quiz(): POST /quiz?code=13 이면 응답 코드는 200, 응답 본문은" +
            "응답 본문은 OK!를 리턴한다.")
    @Test
